...
//	private static final boolean DEBUGGING = false;
	...
	public WikiCrawler(int max, String fileName, Boolean isTopicSensitive){
...
//		    	System.out.println(line);
	...
	{
		String name = "RAW\\" + index + ".txt";
		writeFile(name, filterHtml(contents), false);
...
//		System.out.println(distance);
	...
	private void writeGraph(String contents) {
		writeFile(this.fileName, contents, false);
	}
...
//			if (DEBUGGING) System.out.println("==========================================");
		...
		writeFile("url.txt", urlBuilder.toString(), countNode == max);
