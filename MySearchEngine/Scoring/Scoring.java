...
public class Scoring {
    ...
    Scoring(HashMap<String, Integer> files, HashMap<String, Integer> terms, HashMap<Integer, HashMap<Integer, ArrayList<Integer>>> posting, String[] fileNames, double[] l2NormVd){
    	this.files = files;
    	this.terms = terms;
